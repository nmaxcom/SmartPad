...
export declare class Luminosity {
     ...
     * @returns The new Luminosity instance.
     */
    static FromMilliwatts(value: number): Luminosity;
    /**
     ...
     */
    convert(toUnit: LuminosityUnits): number;
     ...
     */
    toString(unit?: LuminosityUnits): string;
    /**
     ...
     */
    getUnitAbbreviation(unitAbbreviation?: LuminosityUnits): string;
    /**
