...
export declare enum HeatFluxUnits {
    ...
    /** */
    MilliwattsPerSquareMeter = 13,
    /** */
    CentiwattsPerSquareMeter = 14,
    /** */
    DeciwattsPerSquareMeter = 15,
    /** */
    KilowattsPerSquareMeter = 16,
    /** */
    KilocaloriesPerSecondSquareCentimeter = 17
}
...
export declare class HeatFlux {
     ...
     * @returns The new HeatFlux instance.
     */
    static FromMilliwattsPerSquareMeter(value: number): HeatFlux;
    /**
     ...
     */
    convert(toUnit: HeatFluxUnits): number;
     ...
     */
    toString(unit?: HeatFluxUnits): string;
    /**
     ...
     */
    getUnitAbbreviation(unitAbbreviation?: HeatFluxUnits): string;
    /**
