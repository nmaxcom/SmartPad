...
export declare class ElectricPotentialAc {
     ...
     * @returns The new ElectricPotentialAc instance.
     */
    static FromMillivoltsAc(value: number): ElectricPotentialAc;
    /**
     ...
     */
    convert(toUnit: ElectricPotentialAcUnits): number;
     ...
     */
    toString(unit?: ElectricPotentialAcUnits): string;
    /**
     ...
     */
    getUnitAbbreviation(unitAbbreviation?: ElectricPotentialAcUnits): string;
    /**
