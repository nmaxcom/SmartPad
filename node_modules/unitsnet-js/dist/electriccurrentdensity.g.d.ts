...
export declare class ElectricCurrentDensity {
     ...
     */
    convert(toUnit: ElectricCurrentDensityUnits): number;
     ...
     */
    toString(unit?: ElectricCurrentDensityUnits): string;
    /**
     ...
     */
    getUnitAbbreviation(unitAbbreviation?: ElectricCurrentDensityUnits): string;
    /**
