...
export declare class Temperature {
    ...
    private millidegreescelsiusLazy;
    ...
    /** */
    get MillidegreesCelsius(): number;
    /** */
     ...
     * @returns The new Temperature instance.
     */
    static FromMillidegreesCelsius(value: number): Temperature;
    /**
     ...
     */
    convert(toUnit: TemperatureUnits): number;
     ...
     */
    toString(unit?: TemperatureUnits): string;
    /**
     ...
     */
    getUnitAbbreviation(unitAbbreviation?: TemperatureUnits): string;
    /**
