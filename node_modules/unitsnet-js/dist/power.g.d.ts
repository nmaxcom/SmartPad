...
export declare enum PowerUnits {
    ...
    Petawatts = 19,
    /** */
    KilobritishThermalUnitsPerHour = 20,
    /** */
    MegabritishThermalUnitsPerHour = 21,
    /** */
    MillijoulesPerHour = 22,
    /** */
    KilojoulesPerHour = 23,
    /** */
    MegajoulesPerHour = 24,
    /** */
    GigajoulesPerHour = 25
}
...
export declare class Power {
    ...
    private megabritishthermalunitsperhourLazy;
    private millijoulesperhourLazy;
    ...
    /** */
    get MegabritishThermalUnitsPerHour(): number;
    /** */
    get MillijoulesPerHour(): number;
    /** */
     ...
     * @returns The new Power instance.
     */
    static FromMilliwatts(value: number): Power;
    /**
     ...
     * @returns The new Power instance.
     */
    static FromMegabritishThermalUnitsPerHour(value: number): Power;
    /**
     ...
     * @returns The new Power instance.
     */
    static FromMillijoulesPerHour(value: number): Power;
    /**
     ...
     */
    convert(toUnit: PowerUnits): number;
     ...
     */
    toString(unit?: PowerUnits): string;
    /**
     ...
     */
    getUnitAbbreviation(unitAbbreviation?: PowerUnits): string;
    /**
