...
export declare enum TorqueUnits {
    ...
    PoundForceFeet = 5,
    /** */
    GramForceMillimeters = 6,
    /** */
    GramForceCentimeters = 7,
    /** */
    GramForceMeters = 8,
    /** */
    KilogramForceMillimeters = 9,
    /** */
    KilogramForceCentimeters = 10,
    /** */
    KilogramForceMeters = 11,
    /** */
    TonneForceMillimeters = 12,
    /** */
    TonneForceCentimeters = 13,
    /** */
    TonneForceMeters = 14,
    /** */
    KilonewtonMillimeters = 15,
    /** */
    MeganewtonMillimeters = 16,
    /** */
    KilonewtonCentimeters = 17,
    /** */
    MeganewtonCentimeters = 18,
    /** */
    KilonewtonMeters = 19,
    /** */
    MeganewtonMeters = 20,
    /** */
    KilopoundForceInches = 21,
    /** */
    MegapoundForceInches = 22,
    /** */
    KilopoundForceFeet = 23,
    /** */
    MegapoundForceFeet = 24
}
...
export declare class Torque {
    ...
    private poundalfeetLazy;
    private poundforceinchesLazy;
    private poundforcefeetLazy;
    private gramforcemillimetersLazy;
    private gramforcecentimetersLazy;
    private gramforcemetersLazy;
    ...
    /** */
    get PoundalFeet(): number;
    /** */
    get PoundForceInches(): number;
    /** */
    get PoundForceFeet(): number;
    /** */
    get GramForceMillimeters(): number;
    /** */
    get GramForceCentimeters(): number;
    /** */
    get GramForceMeters(): number;
    /** */
     ...
     * @returns The new Torque instance.
     */
    static FromPoundalFeet(value: number): Torque;
    /**
     ...
     * @returns The new Torque instance.
     */
    static FromGramForceMillimeters(value: number): Torque;
    /**
     ...
     * @returns The new Torque instance.
     */
    static FromGramForceCentimeters(value: number): Torque;
    /**
     ...
     * @returns The new Torque instance.
     */
    static FromGramForceMeters(value: number): Torque;
    /**
     ...
     */
    convert(toUnit: TorqueUnits): number;
     ...
     */
    toString(unit?: TorqueUnits): string;
    /**
     ...
     */
    getUnitAbbreviation(unitAbbreviation?: TorqueUnits): string;
    /**
