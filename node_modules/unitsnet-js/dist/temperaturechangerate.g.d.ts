...
export declare enum TemperatureChangeRateUnits {
    ...
    /** */
    MillidegreesCelsiusPerSecond = 4,
    /** */
    CentidegreesCelsiusPerSecond = 5,
    /** */
    DecidegreesCelsiusPerSecond = 6,
    /** */
    DecadegreesCelsiusPerSecond = 7,
    /** */
    HectodegreesCelsiusPerSecond = 8,
    /** */
    KilodegreesCelsiusPerSecond = 9
}
...
export declare class TemperatureChangeRate {
    ...
    private millidegreescelsiuspersecondLazy;
    ...
    /** */
    get MillidegreesCelsiusPerSecond(): number;
    /** */
     ...
     * @returns The new TemperatureChangeRate instance.
     */
    static FromMillidegreesCelsiusPerSecond(value: number): TemperatureChangeRate;
    /**
     ...
     */
    convert(toUnit: TemperatureChangeRateUnits): number;
     ...
     */
    toString(unit?: TemperatureChangeRateUnits): string;
    /**
     ...
     */
    getUnitAbbreviation(unitAbbreviation?: TemperatureChangeRateUnits): string;
    /**
