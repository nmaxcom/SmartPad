...
export declare class LuminousIntensity {
     ...
     */
    convert(toUnit: LuminousIntensityUnits): number;
     ...
     */
    toString(unit?: LuminousIntensityUnits): string;
    /**
     ...
     */
    getUnitAbbreviation(unitAbbreviation?: LuminousIntensityUnits): string;
    /**
