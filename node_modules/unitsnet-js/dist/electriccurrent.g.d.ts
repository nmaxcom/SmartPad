...
export declare class ElectricCurrent {
     ...
     * @returns The new ElectricCurrent instance.
     */
    static FromFemtoamperes(value: number): ElectricCurrent;
    /**
     ...
     * @returns The new ElectricCurrent instance.
     */
    static FromMilliamperes(value: number): ElectricCurrent;
    /**
     ...
     */
    convert(toUnit: ElectricCurrentUnits): number;
     ...
     */
    toString(unit?: ElectricCurrentUnits): string;
    /**
     ...
     */
    getUnitAbbreviation(unitAbbreviation?: ElectricCurrentUnits): string;
    /**
