...
export declare enum ElectricResistivityUnits {
    ...
    MegaohmMeters = 7,
    /** */
    PicoohmsCentimeter = 8,
    /** */
    NanoohmsCentimeter = 9,
    /** */
    MicroohmsCentimeter = 10,
    /** */
    MilliohmsCentimeter = 11,
    /** */
    KiloohmsCentimeter = 12,
    /** */
    MegaohmsCentimeter = 13
}
...
export declare class ElectricResistivity {
    ...
    private milliohmscentimeterLazy;
    ...
    /** */
    get MilliohmsCentimeter(): number;
    /** */
     ...
     * @returns The new ElectricResistivity instance.
     */
    static FromMilliohmMeters(value: number): ElectricResistivity;
    /**
     ...
     * @returns The new ElectricResistivity instance.
     */
    static FromMilliohmsCentimeter(value: number): ElectricResistivity;
    /**
     ...
     */
    convert(toUnit: ElectricResistivityUnits): number;
     ...
     */
    toString(unit?: ElectricResistivityUnits): string;
    /**
     ...
     */
    getUnitAbbreviation(unitAbbreviation?: ElectricResistivityUnits): string;
    /**
