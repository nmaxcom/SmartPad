...
export declare class ElectricPotential {
    private value;
    private voltsLazy;
    private nanovoltsLazy;
    private microvoltsLazy;
    private millivoltsLazy;
    ...
    get Volts(): number;
    /** */
    get Nanovolts(): number;
    /** */
    get Microvolts(): number;
    /** */
    get Millivolts(): number;
    /** */
     ...
     * @returns The new ElectricPotential instance.
     */
    static FromNanovolts(value: number): ElectricPotential;
    /**
     ...
     * @returns The new ElectricPotential instance.
     */
    static FromMillivolts(value: number): ElectricPotential;
    /**
     ...
     */
    convert(toUnit: ElectricPotentialUnits): number;
     ...
     */
    toString(unit?: ElectricPotentialUnits): string;
    /**
     ...
     */
    getUnitAbbreviation(unitAbbreviation?: ElectricPotentialUnits): string;
    /**
