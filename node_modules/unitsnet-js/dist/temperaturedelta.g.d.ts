...
export declare class TemperatureDelta {
     ...
     * @returns The new TemperatureDelta instance.
     */
    static FromMillidegreesCelsius(value: number): TemperatureDelta;
    /**
     * Convert TemperatureDelta to a specific unit value.
     * @param toUnit The specific unit to convert to
     * @returns The value of the specific unit provided.
     */
    convert(toUnit: TemperatureDeltaUnits): number;
     ...
     */
    toString(unit?: TemperatureDeltaUnits): string;
    /**
     ...
     */
    getUnitAbbreviation(unitAbbreviation?: TemperatureDeltaUnits): string;
    /**
