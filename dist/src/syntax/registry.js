...
exports.SUPPORTED_UNITS = exports.SYNTAX_REGISTRY = void 0;
exports.getSyntaxByCategory = getSyntaxByCategory;
exports.getCategories = getCategories;
exports.searchSyntax = searchSyntax;
exports.getSyntaxByPattern = getSyntaxByPattern;
exports.getUnitsByCategory = getUnitsByCategory;
exports.getUnitCategories = getUnitCategories;
exports.searchUnits = searchUnits;
exports.getTotalUnitCount = getTotalUnitCount;
exports.SYNTAX_REGISTRY = [
    // ===== PERCENTAGES =====
    {
        syntax: "x% of y =>",
 ...
 */
function getSyntaxByCategory(category) {
    return exports.SYNTAX_REGISTRY.filter(pattern => pattern.category === category);
}
/**
 * Get all available categories
 */
function getCategories() {
    return [...new Set(exports.SYNTAX_REGISTRY.map(pattern => pattern.category))];
}
/**
 * Search syntax patterns by keyword
 */
function searchSyntax(keyword) {
    const lowerKeyword = keyword.toLowerCase();
    return exports.SYNTAX_REGISTRY.filter(pattern => pattern.syntax.toLowerCase().includes(lowerKeyword) ||
 ...
 */
function getSyntaxByPattern(pattern) {
    return exports.SYNTAX_REGISTRY.filter(syntax => syntax.syntax.includes(pattern) ||
...
function getUnitsByCategory(category) {
    const unitCategory = exports.SUPPORTED_UNITS[category];
...
function getUnitCategories() {
    return Object.keys(exports.SUPPORTED_UNITS);
}
/**
...
function searchUnits(query) {
    ...
    Object.values(exports.SUPPORTED_UNITS).forEach((category) => {
        category.units.forEach((unit) => {
            if (unit.symbol.toLowerCase().includes(lowerQuery) ||
