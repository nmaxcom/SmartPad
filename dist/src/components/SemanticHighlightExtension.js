...
exports.SemanticHighlightExtension = exports.CommentMark = exports.TriggerMark = exports.ScrubbableNumberMark = exports.ErrorMark = exports.ResultMark = exports.FunctionMark = exports.NumberMark = exports.OperatorMark = exports.VariableMark = void 0;
...
exports.VariableMark = core_1.Mark.create({
    name: "variable",
    parseHTML() {
...
exports.OperatorMark = core_1.Mark.create({
    name: "operator",
    parseHTML() {
...
exports.NumberMark = core_1.Mark.create({
    name: "number",
    parseHTML() {
...
exports.FunctionMark = core_1.Mark.create({
    name: "function",
    parseHTML() {
...
exports.ResultMark = core_1.Mark.create({
    name: "result",
    parseHTML() {
...
exports.ErrorMark = core_1.Mark.create({
    name: "error",
    parseHTML() {
...
exports.ScrubbableNumberMark = core_1.Mark.create({
...
exports.TriggerMark = core_1.Mark.create({
    name: "trigger",
    parseHTML() {
...
exports.SemanticHighlightExtension = core_1.Extension.create({
    name: "semanticHighlight",
    addProseMirrorPlugins() {
        const getVariableContext = () => {
            const context = this.options.getVariableContext?.() || new Map();
        ...
        return [
            new prosemirror_state_1.Plugin({
                key: new prosemirror_state_1.PluginKey("semanticHighlight"),
                state: {
                    init() {
                    ...
                    apply(tr, oldState) {
                        ...
                        doc.forEach((node, offset) => {
                            if (node.type.name === "paragraph") {
                                ...
                                const astNode = (0, astParser_1.parseLine)(text, lineNumber); // Parse text into AST
 ...
 */
function extractTokensFromASTNode(astNode, variableContext) {
    const tokens = [];
    ...
    if ((0, ast_1.isCommentNode)(astNode)) {
        tokens.push({
            type: "comment",
            start: 0,
            end: text.length,
    ...
    if ((0, ast_1.isVariableAssignmentNode)(astNode)) {
        ...
        if (equalsIndex !== -1) {
            ...
            const isSimpleNumber = /^-?(?:\d{1,3}(?:,\d{3})+|\d+)(?:\.\d+)?(?:[eE][+-]?\d+)?$/.test(valueText.trim());
    ...
    else if ((0, ast_1.isErrorNode)(astNode)) {
    ...
    else if ((0, ast_1.isFunctionDefinitionNode)(astNode)) {
...
function tokenizeExpression(expr, baseOffset, variableContext) {
    const tokens = [];
    ...
    while (pos < expr.length) {
        ...
        if (!matched) {
            ...
            const shouldParseUnit = lastToken?.type === "scrubbableNumber" ||
...
function matchDateLiteralTokens(expr, pos, baseOffset) {
    const slice = expr.slice(pos);
    const tokens = [];
    const pushDateNumber = (start, length) => {
        tokens.push({
            type: "scrubbableNumber",
            start: baseOffset + start,
    ...
    const pushSeparator = (start, length) => {
        tokens.push({
            type: "operator",
            start: baseOffset + start,
            end: baseOffset + start + length,
