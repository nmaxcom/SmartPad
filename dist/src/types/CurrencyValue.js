 ...
 */
class CurrencyValue extends SemanticValue_1.SemanticValue {
    symbol;
    amount;
    currencyInfo;
    ...
    multiply(other) {
        ...
        if (other.getType() === 'unit') {
            ...
            return new CurrencyUnitValue_1.CurrencyUnitValue(this.symbol, this.amount * unitValue.getNumericValue(), unitValue.getUnit(), false);
        }
        if (other.getType() === 'currency') {
    ...
    divide(other) {
        ...
        if (other.getType() === 'unit') {
            const unitValue = other;
            return new CurrencyUnitValue_1.CurrencyUnitValue(this.symbol, this.amount / unitValue.getNumericValue(), unitValue.getUnit(), true);
        }
        if (other.getType() === 'currency') {
            const otherCurrency = other;
            if (this.symbol !== otherCurrency.symbol) {
            ...
            return new NumberValue_1.NumberValue(this.amount / otherCurrency.amount);
        }
    ...
    power(exponent) {
        ...
        if (exponent === 0) {
            ...
            return new NumberValue_1.NumberValue(1);
        }
     ...
     */
    formatCurrencyAmount(amount, precision) {
     ...
     */
    convertTo(targetSymbol, exchangeRate) {
     ...
     */
    toNumber() {
        return new NumberValue_1.NumberValue(this.amount);
    }
    getMetadata() {
        return {
            ...super.getMetadata(),
