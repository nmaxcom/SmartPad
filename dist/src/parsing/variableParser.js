...
exports.parseVariableAssignment = parseVariableAssignment;
exports.parseVariableAssignmentWithOptionalEvaluation = parseVariableAssignmentWithOptionalEvaluation;
/**
...
function parseVariableAssignment(line) {
    ...
    if (rightParts.length > 2) {
        ...
        if (!isNaN(numericValue)) {
            ...
            const proseWords = /\b(is|are|was|were|the|a|an|some|seems|wrong|secure|good|bad|maybe|think|very|quite|really)\b/;
 ...
 */
function parseVariableAssignmentWithOptionalEvaluation(line) {
    const trimmedLine = line.trim();
