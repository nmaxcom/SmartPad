...
exports.createSettingsState = createSettingsState;
exports.saveSettingsToStorage = saveSettingsToStorage;
...
function createSettingsState() {
    try {
        ...
        if (stored) {
            ...
            const merged = { ...exports.DEFAULT_SETTINGS, ...parsed };
            if (typeof parsed.scientificUpperExponent !== "number" &&
            ...
            if (typeof parsed.scientificLowerExponent !== "number" &&
...
function settingsReducer(state, action) {
    switch (action.type) {
        ...
        case "RESET_SETTINGS": {
            const newState = { ...exports.DEFAULT_SETTINGS };
