...
const SPEC_CATALOG = [
  ...
  },
  {
    ...
    syntax: [
      ...
      "The first icon on a chip is the drag handle. Drag it into another expression to create a live reference.",
      "The copy icon copies the visible value. The menu exposes actions such as `Copy value`, `Insert reference`, and `Insert value`.",
    ],
    checklist: [
      "Use the drag handle or menu when you want a value to stay connected to its source.",
  ...
  },
  {
    ...
    syntax: [
      ...
      "Drag inside a chart to pan, scroll to zoom X, shift-scroll to pan, drag an axis to resize that viewport, and use Reset view or double-click to return to the computed view.",
    ],
    checklist: [
...
const renderFeatureGuideExtraSections = (slug) => {
  if (slug === "result-chips-and-references") {
    return [
      ...
      "",
      "- **Drag handle**: the first icon. Drag it into another line to create a live reference to that result.",
      "- **Copy value**: copies the visible value as plain text.",
      "- **Actions menu**: opens commands such as `Copy value`, `Insert reference`, and `Insert value`.",
      "",
      "Clicking the chip value itself is intentionally conservative. Use the handle or menu when you want SmartPad to change the sheet.",
      "",
      "> GIF/video marker: show a result chip on hover, point out the drag handle, copy icon, and menu.",
      "",
  ...
  if (slug === "plotting-and-dependency-views") {
    return [
      ...
      "- **Reset view**: use the small reset control, or double-click the chart, to return to the computed view.",
      "",
