---
title: "SmartPad Result Chips + Value Graph Spec (V2)"
description: "This spec extends Live Result into a full interaction model where results are:"
---

> Source: `docs/Specs/ResultChipsAndValueGraph.spec.md`
