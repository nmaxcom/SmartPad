---
title: "SmartPad Currency + FX Spec"
description: "This spec defines currency as a first-class unit, how FX conversion works, and how manual rate overrides interact with live data. It is written to fit SmartPad's existing unit math and `to`/`in` conversion rules."
---

> Source: `docs/Specs/Currency.spec.md`
