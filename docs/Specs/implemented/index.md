...
| Baseline Comparison | `docs/Specs/implemented/baseline-comparison.md` | `docs/Specs/BaselineComparison.spec.md` | `tests/unit/variableBaselineStore.test.ts`, `tests/unit/variablePanelBaseline.test.tsx`, `tests/e2e/variable-baseline-comparison.spec.ts` |
