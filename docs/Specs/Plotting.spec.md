...
* Double-clicking the chart restores the viewport to the computed view (instead of the full domain).
* Editing source values, expressions, or function bodies must not reset a user-adjusted viewport.
