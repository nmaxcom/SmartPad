...
- Autocomplete is less aggressive: automatic suggestions wait for a typed token character, while a recorded Settings shortcut opens contextual suggestions on demand. The default avoids common OS-reserved shortcuts.
