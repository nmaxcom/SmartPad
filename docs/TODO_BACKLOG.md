...
| T-2026-02-14-01 | project | Ship professional docs UI baseline (desktop + mobile) without manual bug triage | Assistant | todo | p0 | 2026-02-16 | Apply a docs theme/system where heading hierarchy, spacing rhythm, code blocks, tables, nav states, and mobile breakpoints are production-ready out of the box |
...
| T-2026-02-14-04 | project | Migrate docs delivery from hand-styled static page to Docusaurus | Assistant | in_progress | p0 | 2026-02-15 | Scaffolded `website/` + spec-to-Docusaurus generator; next unblock network install/build and switch production docs URL to deployed Docusaurus site |
