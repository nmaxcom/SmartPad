...
| T-2026-02-14-04 | project | Migrate docs delivery from hand-styled static page to Docusaurus | Assistant | in_progress | p0 | 2026-02-15 | Scaffold `website/` Docusaurus app, port generated/spec content into docs pages, and make app Docs button resolve to deployed Docusaurus route |
